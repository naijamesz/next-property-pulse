...
export default function PropertyEditForm() {
  ...
  // fields and setFields state for get any things in form field after submit
  const [fields, setFields] = useState({
    type: '',
    name: '',
    description: '',
    // location type is object within street city state zipcode there're type is string in the object
    location: {
      street: '',
      city: '',
      state: '',
    ...
    baths: '',
    square_feet: '',
    // amenities type is array
    amenities: [],
    // rates type is object within weekly monthly nightly there're type is empty string in the object
    rates: {
      weekly: '',
      monthly: '',
      nightly: ''
    },
    // info type is object within weekly monthly nightly there're type is empty string in the object
    seller_info: {
      name: '',
      email: '',
      phone: ''
