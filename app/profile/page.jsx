                    ...
                    <div key={property._id} className='mb-10'>
                      ...
                      <div className='mt-2'>
                        <Link
                          ...
                          className='px-4 py-1 mr-2 text-white bg-green-500 rounded-md hover:bg-green-700'>
                          Edit
                        </Link>
                        <button
                          onClick={() => handleDeleteProperty(property._id)}
                          className='px-3 py-3 mr-2 text-white bg-red-500 rounded-md hover:bg-red-700'
                          type='button'>
                          Delete
                        </button>
                      </div>
